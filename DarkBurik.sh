...
def siapa():
	os.system('clear')
	nama = raw_input("\033[1;97mSiapa nama kamu Tod ? \033[1;91m: \033[1;92m")
	if nama =="":
		...
		os.system('clear')
		jalan("\033[1;97mWellcome Pedatang Baru \033[1;92m" +nama+ "\n\033[1;97mTerimakasih telah menggunakan tools ini !!")
		time.sleep(1)
		loginSC()
...
def loginSC():
	...
	username = raw_input("\033[1;96m[*] \033[1;97mUsername Tod \033[1;91m: \033[1;92m")
	password = raw_input("\033[1;96m[*] \033[1;97mPassword Tol \033[1;91m: \033[1;92m")
	if username =="Anjay" and password =="bacot":
...
def login():
	...
	try:
		...
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91mSepertinya akun Loh kena checkpoint Sayang Sekali")
